...
(() => {
  ...
  window.addEventListener('beforeinstallprompt', function (t) {
    t.preventDefault(), (o = t), (i.style.display = 'block');
  }),
    i.addEventListener(
      'click',
      n(
                ...
                switch ((t.prev = t.next)) {
                  ...
                  case 8:
                    (e = t.sent),
                      (n = e.outcome),
                      console.log(
                        'User response to the install prompt: '.concat(n)
                      ),
                      (t.next = 16);
                    break;
                  case 13:
                    (t.prev = 13),
                      (t.t0 = t.catch(4)),
                      console.error('Installation failed', t.t0);
                  case 16:
                    return (t.prev = 16), (o = null), t.finish(16);
                  case 19:
                  case 'end':
                    return t.stop();
                }
    ...
    window.addEventListener('appinstalled', function (t) {
      (o = null), console.log('PWA was installed');
    });
})();
